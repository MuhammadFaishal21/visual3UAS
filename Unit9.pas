...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('NAMA PT BELUM DIISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
    ShowMessage('ALAMAT PT BELUM SESUAI');
    end else
     if e_4.text=''then
    begin
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update supplier set id= "'+e_1.Text+'",nama_pt="'+e_2.Text+'",alamat_pt="'+e_3.Text+'",nomor_telpon="'+e_4.Text+'",email="'+e_5.Text+'" where id="'+id+'"');
