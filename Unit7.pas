...
begin
 if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('USER ID BELUM DIISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into penjual values("'+e_1.Text+'","'+e_2.Text+'","'+formatdatetime('yyyy-mm-dd',dtp1.Date)+'","'+e_3.Text+'","'+e_4.Text+'")');
 zqry1.ExecSQL ;

 zqry1.SQL.Clear;
 zqry1.SQL.Add('select * from penjual');
 zqry1.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update penjual set id= "'+e_1.Text+'",user_id="'+e_2.Text+'",kostumer_id="'+e_3.Text+'",total="'+e_4.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from penjual where id="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from penjual');
zqry1.Open;
