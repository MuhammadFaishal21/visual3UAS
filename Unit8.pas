...
if e_1.Text='' then
  begin
    ...
    ShowMessage('OBAT ID BELUM SESUAI');
     ...
     if e_4.text=''then
    begin
    ShowMessage('EXP ID BELUM SESUAI');
    end else
     if e_5.text=''then
    begin
    ShowMessage('QTY ID BELUM SESUAI');
    end else
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into pembeli values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'","'+formatdatetime('yyyy-mm-dd',dtp1.Date)+'")');
 zqry1.ExecSQL ;
